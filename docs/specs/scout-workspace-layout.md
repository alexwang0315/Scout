...
| Sec. 7 Readiness & Pace Fit | pace coefficient, team pace fit, energy reserve, segment timing, daylight and workload estimates | `normalized/pace/pace_coefficients.json`, `normalized/pace/team_pace_fit.json`, `outputs/resource_plan.json`, `outputs/planned_eta.json`, `outputs/timing_measurements.json`, `outputs/weather_daylight_evidence.json`, post-analysis imported refs | Advisory planning evidence, not medical diagnosis |
