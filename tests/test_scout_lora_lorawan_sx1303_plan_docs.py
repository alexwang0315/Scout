...
def test_lora_lorawan_sx1303_plan_is_mainline_and_bounded() -> None:
    ...
    required = [
        ...
        "`Safety / Emergency` may summarize emergency-relevant sender readiness",
        "not be the primary sender workbench",
        "`Debug Message` may mirror read-only sender status",
        "visually and architecturally separated as a local action lane",
