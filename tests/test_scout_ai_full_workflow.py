...
def test_full_workflow_surfaces_standard_gap_overview_before_six_power() -> None:
    result = run_scout_ai_full_workflow(
    ...
    assert result.answer.startswith("標準差異檢視：")
...
def test_full_workflow_uses_review_gap_for_provenance_promotion_question() -> None:
    result = run_scout_ai_full_workflow(
    ...
    source = _workflow_source(result, REVIEW_GAP_TOOL_ID)
