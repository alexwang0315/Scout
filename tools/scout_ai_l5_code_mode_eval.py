...
def _l5_system_prompt() -> str:
    return (
        ...
        "For a nearest-water question expressed as a trail mileage such as 12.5K, "
        "use operation='filter', artifact={'project_ref_key': "
        "'mileage_tag_alignment_geojson_ref', 'collection_path': 'features'}, "
        "predicates=[{'field': 'properties.source_label', 'operator': 'contains', "
        "'value': '水源'}], fields=['properties.source_id', "
        "'properties.source_label', 'properties.route_distance_m', "
        "'properties.route_projection_status', 'geometry.coordinates'], and limit=100. "
        "In sandboxed Python parse the signed K value from each source_label and minimize "
