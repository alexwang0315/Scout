...
def require_pydantic_ai_229_or_newer() -> dict[str, str]:
    ...
    if installed_release < (2, 29, 0):
        raise RuntimeError(
            "This eval requires pydantic-ai-slim 2.29.0 or newer; "
...
def run_eval(args: argparse.Namespace) -> Path:
    ...
    if model_calls_required:
        ...
        runtime_versions = require_pydantic_ai_229_or_newer()
