...
def build_pretrip_implementation_status_manifest() -> PreTripImplementationStatusManifest:
    return PreTripImplementationStatusManifest(
        ...
        boundary={
            "metadata_only": True,
            "alpha_workable_mode": True,
            "runtime_mutation_allowed": True,
            "runtime_export_write_allowed": True,
            "runtime_activation_allowed_for_alpha": True,
            "runtime_operator_confirmation_required": True,
            "phase1_live_runtime_touched": False,
            "phase1_live_runtime_touch_allowed_for_alpha": True,
            "phase2_bridge_touched": False,
            "phase2_bridge_allowed_for_alpha": True,
            "ui_scope_included": True,
            "ui_scope": "alpha_workable_admin",
            "notes": [
                "Alpha workable status map for Phase 4 implementation tracking.",
                "Admin UI, importer, workspace edits, map layers, live opt-in providers, and runtime handoff tooling are open for alpha validation.",
            ...
            "Alpha opens previously blocking product boundaries for workable testing through explicit operator actions; pretrip evidence stays labeled before any runtime-authority handoff.",
        ],
        },
        validation_commands={
